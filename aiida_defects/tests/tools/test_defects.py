...
class TestDefects(object):
    ...
    def test_defect_creator_vacancy(self, aiida_profile, test_structures):
        ...
        np.testing.assert_allclose(host_unitcell*2, host_supercell, atol=1.e-9)
        ...
        reference = {'position': (2.72665, 2.72665, 2.72665), 'kind_name': 'Cl'} 
    ...
    def test_defect_creator_cluster(self, aiida_profile, test_structures):
        ...
        references = {
            'cluster_1': [{'position': (0., 0., 0.), 'kind_name': 'K'},
            ],
        }
        ...
        for index in range(1,5):
            ...
            for defect_site in cluster_sites:
                ...
                for ref_site in references[cluster_label]:
                    ...
                    assert len(defect_site)==0 , "Unexpected key found in cluster site definition"
                    # Matching site found?
    ...
    def test_distance_from_defect(self, aiida_profile, test_structures):
        ...
        distances_reference = np.array([0.0, 3.421396265623875, 2.7682664798028385, 2.80611880625625, 2.80611880625625])
        ...
        np.testing.assert_allclose(distances_calculated, distances_reference, atol=1.e-9)
    ...
    def test_distance_from_defect_pymatgen(self, aiida_profile, test_structures):
        """
    ...
    @pytest.mark.skip(reason="Cluster returns a list instead of a numpy array and breaks the comparison")
    def test_explore_defect(self, aiida_profile, test_structures):
        ...
        result = aiida_defects.tools.defects.explore_defect(host_structure, defect_structure, 'vacancy')
        ...
        result = aiida_defects.tools.defects.explore_defect(host_structure, defect_structure, 'substitution')
        ...
        result = aiida_defects.tools.defects.explore_defect(host_structure, defect_structure, 'cluster')
        ...
        # Case 4 - Unknown
        defect_structure = test_structures['halite_bulk_v_cl_sub_k']
        result = aiida_defects.tools.defects.explore_defect(host_structure, defect_structure, 'unknown')
    ...
    @pytest.mark.skip(reason='Find index appears to be broken for clusters. Also need to make output keys more generic.')
