...
@calcfunction
def get_charge_model_with_siesta_mesh(limits,
                     dimensions,
                     defect_position,
                     sigma,
                     charge):
...
@calcfunction
def get_model_potential_with_siesta_mesh(cell_matrix, dimensions, charge_density, epsilon):
    """
    3D possion solver
    ...
    V_model_g[dimensions[0] , dimensions[1] , dimensions[2] ] = 0.0
