...
from aiida.workflows.user.aiida_defects.pp.fft_tools import planar_average, read_grid, differentiator
...
class BulkEpsilonSawtoothWorkChain(WorkChain):
    ...
    def compute_bulk_epsilon(self):
        ...
        cell_x1 = int((1.5/float(self.inputs.sc)) *400)
        cell_x2 = int((2.5/float(self.inputs.sc))*400)
        
        cell_x3 = int((4.5/float(self.inputs.sc))*400)
        cell_x4 = int((5.5/float(self.inputs.sc))*400)
        ...
        self.report("BulkEpsilonSawtoothWorkChain completed succesfully. The {} Epsilon value is {} eV".format(self.inputs.epsilon_type,
                                                                                                               epsilon))
        
#        plt.plot(Ve1['ax'],Vsaw['average'])
#        plt.plot(Ve1['ax'],Vdiff)
#        plt.show()
        
#         plt.plot(Ve1['ax'],Ve1['average'])
#         plt.plot(Ve0['ax'],Ve0['average'])
#         plt.show()
